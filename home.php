...
<head>
  ...
  <title>Wall_street- Find your dream house</title>
...
<body>
  ...
  <!--  <h1>Welcome to Wall Street Real Estate</h1>
  <p>Hello,  Explore your dream home.</p>

    - #HEADER
  --><!--<a href="signin.php" onclick="event.preventDefault();documnet.getElementById('').submit();">Logout</a>
  ...
  <header class="header" data-header>
    ...
    <div class="header-bottom">
      <div class="container">
        ...
        <a href="#" class="logo">
          <img src="photos/es4.jpg" alt="Wall Street">
        </a>
        ...
        <nav class="navbar" data-navbar>
          ...
          <div class="navbar-top">
            ...
            <a href="#" class="logo">
              <img src="photos/es3.jpg" alt="Homeverse logo">
            </a>
          ...
          <div class="navbar-bottom">
            <ul class="navbar-list">
              ...
              <li>
                <a href="propertis.html" class="navbar-link" data-nav-link>Property</a>
              </li>
        ...
        <div class="header-bottom-actions">
              ...
              <a href="profile.html" class="header-bottom-actions-btn" aria-label="Profile">
      ...
      <section class="hero" id="home">
        <div class="container">
          ...
          <figure class="hero-banner">
            <img src="photos/mansion10.jpg" alt="Modern house model" class="w-100">
          </figure>
      ...
      <section class="about" id="about">
        <div class="container">
          ...
          <figure class="about-banner">
            <img src="photos/about-banner-1.png" alt="House interior">

            <img src="photos/about-banner-2.jpg" alt="House interior" class="abs-img">
          </figure>
          ...
          <ul class="service-list">
            ...
            <li>
              <div class="service-card">
                ...
                <div class="card-icon">
                  <img src="photos/service-1.png" alt="Service icon">
                </div>
            ...
            <li>
              <div class="service-card">
                ...
                <div class="card-icon">
                  <img src="photos/service-2.png" alt="Service icon">
                </div>
            ...
            <li>
              <div class="service-card">
                ...
                <div class="card-icon">
                  <img src="photos/service-3 (1).png" alt="Service icon">
                </div>
              ...
              <div class="property-card">
                ...
                <div class="card-content">
                  ...
                  <div class="card-price">
                    <strong>₹500,00,000</strong>/Month
                  </div>
            ...
            <li>
              <div class="property-card">
                ...
                <figure class="card-banner">
                  ...
                  <a href="#">
                    <img src="photos/mansion2.jpg" alt="Modern Apartments" class="w-100">
                  </a>
                ...
                <div class="card-content">
                  ...
                  <div class="card-price">
                    <strong>₹400,00,000</strong>/Month
                  </div>
            ...
            <li>
              <div class="property-card">
                ...
                <figure class="card-banner">
                  ...
                  <a href="#">
                    <img src="photos/property-3.jpg" alt="Comfortable Apartment" class="w-100">
                  </a>
                ...
                <div class="card-content">
                  ...
                  <div class="card-price">
                    <strong>₹20,000,000</strong>/Month
                  </div>
            ...
            <li>
              <div class="property-card">
                ...
                <div class="card-content">
                  ...
                  <div class="card-price">
                    <strong>₹340,900,000</strong>/Month
                  </div>
          ...
          <ul class="blog-list has-scrollbar">
            ...
            <li>
              <div class="blog-card">
                ...
                <figure class="card-banner">
                  <img src="photos/blog-1.png" alt="The Most Inspiring Interior Design Of 2021" class="w-100">
                </figure>
            ...
            <li>
              <div class="blog-card">
                ...
                <figure class="card-banner">
                  <img src="photos/blog-2.jpg" alt="Recent Commercial Real Estate Transactions" class="w-100">
                </figure>
            ...
            <li>
              <div class="blog-card">
                ...
                <figure class="card-banner">
                  <img src="photos/blog-3.jpg" alt="Renovating a Living Room? Experts Share Their Secrets"
                    class="w-100">
                </figure>
    ...
    <div class="footer-top">
      <div class="container">
        ...
        <div class="footer-brand">
          ...
          <a href="#" class="logo">
            <img src="photos/es4.jpg" alt="Homeverse logo" style="height: 50px;">
          </a>

          <p class="section-text">
            The growth in the PropTech industry, short for “property technology,” is nowhere better demonstrated than by the growth in application programming interfaces (APIs). These interfaces serve real estate professionals, marketers, investors, and anyone seeking real estate and property information.
          </p>
          ...
          <ul class="contact-list">
            ...
            <li>
              <a href="tel:+911234567891" class="contact-link">
                <ion-icon name="call-outline"></ion-icon>

                <span>+91124567891</span>
              </a>
            </li>

            <li>
              <a href="mailto:wallstreet01@gmail.com" class="contact-link">
                <ion-icon name="mail-outline"></ion-icon>

                <span>wallstreet01@gmail.com</span>
              </a>
            </li>
        ...
        <div class="footer-link-box">
          ...
          <ul class="footer-list">
            ...
            <li>
              <a href="bloge.html" class="footer-link">Blog</a>
            </li>
